        ...
        <Link href={`${props.url}`} className="max-w-[378.20px] pb-10 relative rounded-[32px] border border-[#666666]">
            ...
            <section className='relative px-5 grid gap-5'>
                <div className="grid grid-cols-2">
                    <div className=" text-[#666666] text-lg font-normal font-['Fredoka'] leading-[30.87px] tracking-wide flex items-center justify-start gap-2 w-full"><ClockIcon className='w-6 h-6' />{timeAgo}</div>
